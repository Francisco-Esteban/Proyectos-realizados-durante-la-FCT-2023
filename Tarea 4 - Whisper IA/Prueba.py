...
if os.path.exists(camino_al_audio):
    ...
    if processor and model:
        ...
        if os.path.exists(camino_al_audio_nuevo):
            ...
            # Función para dividir el audio en fragmentos
            def divide_audio(audio_path, chunk_length_ms):
            ...
            def transcribe_chunk(chunk, model):
                ...
                audio_chunk, _ = librosa.load("temp_chunk.wav", sr=16000)
            ...
            chunks = divide_audio(camino_al_audio_nuevo, chunk_length_ms)
